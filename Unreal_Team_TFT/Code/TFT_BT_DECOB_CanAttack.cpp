...
UTFT_BT_DECOB_CanAttack::UTFT_BT_DECOB_CanAttack()
{
	NodeName = TEXT("CanAttack");
}

bool UTFT_BT_DECOB_CanAttack::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
